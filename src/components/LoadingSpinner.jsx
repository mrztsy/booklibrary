  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-6">
      ...
      <div className="relative w-16 h-16">
        {/* Outer ring */}
        <svg className="animate-spin w-16 h-16 text-teal-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 text-teal-700" stroke="currentColor" strokeWidth="1.8">
